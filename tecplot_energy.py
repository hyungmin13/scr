...
def Derivatives2(dynamic_params, all_params, g_batch, model_fns):
    ...
    uxts = np.concatenate([out_xt[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,0] for k in range(len(keys))],1)
    uyts = np.concatenate([out_yt[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,0] for k in range(len(keys))],1)
    uzts = np.concatenate([out_zt[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,3]/all_params["domain"]["in_max"][0,0] for k in range(len(keys))],1)
    uxxs = np.concatenate([out_xx[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,1] for k in range(len(keys))],1)
    uxys = np.concatenate([out_xy[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,2] for k in range(len(keys))],1)
    uxzs = np.concatenate([out_xz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
    uyys = np.concatenate([out_yy[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,2] for k in range(len(keys))],1)
    uyzs = np.concatenate([out_yz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
    uzzs = np.concatenate([out_zz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,3]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
    uxxxs = np.concatenate([out_xxx[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,1] for k in range(len(keys))],1)
    uxxys = np.concatenate([out_xxy[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,2] for k in range(len(keys))],1)
    uxxzs = np.concatenate([out_xxz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
    uxyys = np.concatenate([out_xyy[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,2] for k in range(len(keys))],1)
    uyyys = np.concatenate([out_yyy[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,2] for k in range(len(keys))],1)
    uyyzs = np.concatenate([out_yyz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
    uxzzs = np.concatenate([out_xzz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,1]/all_params["domain"]["in_max"][0,3]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
    uyzzs = np.concatenate([out_yzz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,2]/all_params["domain"]["in_max"][0,3]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
    uzzzs = np.concatenate([out_zzz[:,0,k:(k+1)]*all_params["data"][keys[k]]/all_params["domain"]["in_max"][0,3]/all_params["domain"]["in_max"][0,3]/all_params["domain"]["in_max"][0,3] for k in range(len(keys))],1)
